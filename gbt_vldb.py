...
class GBTx():
    ...
    def gbtx_write_config_file (self,config_file = 'config.txt'): # 'GBTx_config_hptd_test.txt'
...
if __name__ == '__main__':
    ...
    #gbt.gbtx_write_config_file("config_master.txt")

    # register=[]
    # for i in range (0, 435):
    #     register.append(gbt.gbtx_read_register(i))
    # print register

    #gbt.gbtx_dump_config("config_master.txt") # 'GBTx_config_hptd_test.txt'

    #for i in range (0, 421,16):
...
#
   ...
   # print gbt.gbtx_read_register(253)
    ...
    # BEGIN DCDC example
    #gbt.setio1(0) # 0 = 1.5V DC/DC on
    #gbt.setio2(0) # 0 = 2.5V DC/DC on
    # END DCDC example
